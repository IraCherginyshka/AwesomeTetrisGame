...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameBoardComponent = /** @class */ (function () {
                function GameBoardComponent(gameService, toastrService) {
                ...
                GameBoardComponent.prototype.ngOnInit = function () {
                    ...
                    this.currentLevel = 1;
                    this.subscriptionState = this.gameService.getGameState().subscribe(function (gameState) {
                        _this.textStateOverlay = _enums_game_state_enum__WEBPACK_IMPORTED_MODULE_9__["GameState"].PAUSE;
                        _this.isPlaying = gameState !== _enums_game_state_enum__WEBPACK_IMPORTED_MODULE_9__["GameState"].PAUSE;
                        if (_this.isLostGame) {
                            _this.gameService.setInitialInformation();
                        }
                        _this.isLostGame = false;
                    ...
                    this.subscriptionMove = this.gameService
                        .onNextStep()
                        .subscribe(function (nextPosition) {
                        if (nextPosition === _enums_figures_movement_enum__WEBPACK_IMPORTED_MODULE_8__["FiguresMovement"].LEFT) {
                            if (_this.checkCollisionDetection(-1, _this.currentFigure)) {
                                _this.figurePosition -= 1;
                                _this.redrawBoard();
                            }
                        }
                        ...
                        if (nextPosition === _enums_figures_movement_enum__WEBPACK_IMPORTED_MODULE_8__["FiguresMovement"].ROTATE) {
                            var rotateFigure = _this.rotateFigure(_this.currentFigure);
                            if (_this.checkCollisionDetection(0, rotateFigure)) {
                                _this.currentFigure = rotateFigure;
                                _this.redrawBoard();
                            }
                        }
                        if (nextPosition === _enums_figures_movement_enum__WEBPACK_IMPORTED_MODULE_8__["FiguresMovement"].DOWN) {
                            clearInterval(_this.timeInterval);
                            _this.duration = _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["DELAY_DEFAULT"] / _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["ACCELERATION"];
                            _this.playGame();
                        }
                        if (nextPosition === _enums_figures_movement_enum__WEBPACK_IMPORTED_MODULE_8__["FiguresMovement"].DOWN_OFF) {
                            clearInterval(_this.timeInterval);
                            _this.duration = _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["DELAY_DEFAULT"] - _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["DELAY_LEVEL_STEP"] * _this.currentLevel;
                            _this.playGame();
                        }
                    });
                    this.subscriptionNext = this.gameService
                        ...
                        var previousFigure = _a.previousFigure;
                        _this.currentFigure = previousFigure;
                        _this.setInitialBoardState();
                    });
                    this.subscriptionLevel = this.gameService
                        .onUpdateGameInformation()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (gameStats) { return _this.currentLevel !== gameStats.level; }))
                        .subscribe(function (_a) {
                        var level = _a.level;
                        clearInterval(_this.timeInterval);
                ...
                GameBoardComponent.prototype.rotateFigure = function (figureMatrix) {
                    var reverseMatrix = figureMatrix.slice();
                    reverseMatrix.reverse();
                    return reverseMatrix[0].map(function (item, index) { return reverseMatrix.map(function (line) { return line[index]; }); });
                };
                GameBoardComponent.prototype.redrawBoard = function () {
                    var newFigure = new _models_figure_model__WEBPACK_IMPORTED_MODULE_5__["FigureModel"]();
                    var newBoard = new _models_board_model__WEBPACK_IMPORTED_MODULE_6__["BoardModel"](this.ctx, false);
                ...
                GameBoardComponent.prototype.setInitialBoardState = function () {
                    this.lineWithFigure = 0;
                    this.figurePosition = _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["CENTRAL_ITEM"];
                    this.duration = _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["DELAY_DEFAULT"];
                };
                GameBoardComponent.prototype.playGame = function () {
                    var _this = this;
                    this.timeInterval = window.setInterval(function () {
                        if (_this.checkCollisionDetection(0, _this.currentFigure)) {
                            _this.redrawBoard();
                            _this.lineWithFigure += 1;
                        }
                        else if (!_this.checkCollisionDetection(0, _this.currentFigure) &&
                            _this.lineWithFigure === 0) {
                            _this.redrawBoard();
                            _this.lostGame();
                        }
                        else {
                            _this.deleteFilledLines();
                            _this.boardMatrix = _this.currentMatrix;
                            _this.gameService.updateFigures();
                            _this.redrawBoard();
                            _this.setInitialBoardState();
                        }
                    }, this.duration);
                };
                GameBoardComponent.prototype.checkCollisionDetection = function (step, figure) {
                    var _this = this;
                    return figure.every(function (line, indexY) {
                        return line.every(function (block, indexX) {
                            if (block === _enums_figures_colors_enum__WEBPACK_IMPORTED_MODULE_7__["FiguresColors"].DEFAULT) {
                                return true;
                            }
                            var x = _this.figurePosition + indexX + step;
                            var y = _this.lineWithFigure + indexY;
                            if (x >= 0 && x <= _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["QUANTITY_BLOCKS_WIDTH"] && y < _constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["QUANTITY_BLOCKS_HEIGHT"]) {
                                return _this.boardMatrix[y][x] === _enums_figures_colors_enum__WEBPACK_IMPORTED_MODULE_7__["FiguresColors"].DEFAULT;
                            }
                            return false;
                        });
                    });
                };
                GameBoardComponent.prototype.deleteFilledLines = function () {
                    var _this = this;
                    var filledLineIndexes = _models_board_model__WEBPACK_IMPORTED_MODULE_6__["BoardModel"].findFilledLine(this.currentFigure, this.currentMatrix, this.lineWithFigure);
                    if (filledLineIndexes.length > 0) {
                        this.gameService.setNumberFilledLines(filledLineIndexes.length);
                        filledLineIndexes.forEach(function (number) {
                            _this.currentMatrix.splice(_this.lineWithFigure - 1 + number, 1);
                            _this.currentMatrix.unshift(new Array(_constants_board_component_const__WEBPACK_IMPORTED_MODULE_10__["QUANTITY_BLOCKS_WIDTH"]).fill(_enums_figures_colors_enum__WEBPACK_IMPORTED_MODULE_7__["FiguresColors"].DEFAULT));
                        });
                    }
                };
                ...
                GameBoardComponent.prototype.lostGame = function () {
                    var _this = this;
                    this.isLostGame = true;
                    this.isPlaying = false;
                    this.gameService.setLostGame().subscribe(function () {
                        _this.toastrService.warning('You have successfully added your result to Leaderboard');
                    });
                    this.gameService.updateFigures();
                    this.setInitialBoardState();
                    clearInterval(this.timeInterval);
            ...
            GameBoardComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GameControlOptionComponent = /** @class */ (function () {
                function GameControlOptionComponent() {
                }
                return GameControlOptionComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameControlsComponent = /** @class */ (function () {
                function GameControlsComponent(gameService) {
                    this.gameService = gameService;
                ...
                GameControlsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.subscriptionState = this.gameService.getGameState().subscribe(function (gameState) {
                        _this.isPlaying = gameState !== _enums_game_state_enum__WEBPACK_IMPORTED_MODULE_4__["GameState"].PAUSE;
                        _this.isLostGame = false;
                    });
                    this.subscriptionLost = this.gameService.onLostGame().subscribe(function () {
                        _this.isLostGame = true;
                    });
                };
                GameControlsComponent.prototype.ngOnDestroy = function () {
                    this.subscriptionLost.unsubscribe();
                    this.subscriptionState.unsubscribe();
                };
                GameControlsComponent.prototype.keyBoardInput = function (event) {
                ...
                GameControlsComponent.prototype.keyBoardUp = function (event) {
                    if (!this.isPlaying || this.isLostGame) {
                        return;
                    }
                    event.preventDefault();
                ...
                GameControlsComponent.prototype.moveFigure = function (step) {
                    this.gameService.setMoveStep(step);
                };
                return GameControlsComponent;
            }());
            GameControlsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameHeaderComponent = /** @class */ (function () {
                function GameHeaderComponent(userService, toastrService) {
                    this.userService = userService;
                    this.toastrService = toastrService;
                    this.userIsAuthenticated = !!localStorage.getItem('access_user');
                }
                GameHeaderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.toastrService.overlayContainer = this.toastContainer;
                    if (!this.userIsAuthenticated) {
                        setTimeout(function () { return _this.toastrService.info('Please login to save your score to leaderboard'); });
                    }
                    this.authSubscription = this.userService
                        .getAuthListener()
                        .subscribe(function (user) {
                        if (user) {
                            _this.toastrService.success('Welcome to AwesomeTetrisGame!');
                ...
                GameHeaderComponent.prototype.ngOnDestroy = function () {
                    this.authSubscription.unsubscribe();
                };
                return GameHeaderComponent;
            }());
            GameHeaderComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_game_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/game.service */ "./src/app/services/game.service.ts");
            var GameInformationComponent = /** @class */ (function () {
                function GameInformationComponent(gameService) {
                    this.gameService = gameService;
                    this.gameStats$ = this.gameService.onUpdateGameInformation();
                }
                return GameInformationComponent;
            }());
            GameInformationComponent.ctorParameters = function () { return [
                { type: _services_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameLeaderboardComponent = /** @class */ (function () {
                function GameLeaderboardComponent(gameService, userService) {
                    this.gameService = gameService;
                    this.userService = userService;
                ...
                GameLeaderboardComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.gameService.getPlayerGameResult().subscribe(function (results) {
                        _this.gameResults = results.slice(0, _constants_game_information_const__WEBPACK_IMPORTED_MODULE_4__["LEADERBOARD_MAX_WIDTH"]);
                        _this.currentPlayerPlace = results.findIndex(function (player) { return player.username === _this.currentPlayerName; });
                        _this.isCurrentPlayerNotInTop = _this.currentPlayerPlace > _constants_game_information_const__WEBPACK_IMPORTED_MODULE_4__["LEADERBOARD_MAX_WIDTH"];
                        if (_this.isCurrentPlayerNotInTop) {
                            _this.currentPlayerNotInTop = results[_this.currentPlayerPlace];
                        }
                    });
                    this.userService.getAuthListener().subscribe(function (user) {
                        if (!user) {
                            _this.isCurrentPlayerNotInTop = false;
                            _this.currentPlayerName = null;
                        }
                    });
                };
                return GameLeaderboardComponent;
            }());
            GameLeaderboardComponent.ctorParameters = function () { return [
                { type: _services_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"] },
                { type: _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GameLoaderComponent = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameLoginFormComponent = /** @class */ (function () {
                function GameLoginFormComponent(route, userService, toastrService, router) {
                    this.route = route;
                    this.userService = userService;
                    this.toastrService = toastrService;
                    this.router = router;
                ...
                GameLoginFormComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.toastrService.overlayContainer = this.toastContainer;
                    ...
                    this.querySubscription = this.route.queryParams.subscribe(function (queryParam) {
                        _this.isSignUpForm = queryParam.form;
                    });
                };
                GameLoginFormComponent.prototype.onLogin = function () {
                    var _this = this;
                    if (this.logInForm.invalid) {
                        return;
                    }
                    this.userService.loginUser(this.logInForm.value).subscribe(function (_a) {
                        ...
                        _this.toastrService.error('Username and/or Password incorrect. Try again.', '', {
                            timeOut: 3000,
                        });
                    });
                };
                GameLoginFormComponent.prototype.onSignUp = function () {
                    var _this = this;
                    if (this.signUpForm.invalid) {
                        return;
                    }
                    this.userService.createUser(this.signUpForm.value).subscribe(function (res) {
                        if (res) {
                            _this.toastrService.warning('You have successfully Signed Up! Please, LogIn');
                        ...
                        _this.toastrService.error('This name is already used. Please, choose another.', '', {
                            timeOut: 3000,
                        });
                    });
                };
                return GameLoginFormComponent;
            }());
            GameLoginFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GameMainComponent = /** @class */ (function () {
                function GameMainComponent() {
                }
                return GameMainComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameNextFigureComponent = /** @class */ (function () {
                function GameNextFigureComponent(gameService) {
                    this.gameService = gameService;
                }
                GameNextFigureComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.ctx = this.nextCanvas.nativeElement.getContext('2d');
                    this.subscriptionNext = this.gameService
                        .onNewFigureCreated()
                        .subscribe(function (_a) {
                        var randomNextFigure = _a.randomNextFigure;
                        _this.setInitialState(randomNextFigure);
                    });
                    this.gameService.updateFigures();
                };
                GameNextFigureComponent.prototype.ngOnDestroy = function () {
                    this.subscriptionNext.unsubscribe();
                };
                GameNextFigureComponent.prototype.setInitialState = function (nextFigure) {
                    this.nextFigure = nextFigure;
                    var newBoard = new _models_board_model__WEBPACK_IMPORTED_MODULE_2__["BoardModel"](this.ctx, true);
                ...
                return GameNextFigureComponent;
            }());
            GameNextFigureComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_game_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/game.service */ "./src/app/services/game.service.ts");
            var GameStateControlsComponent = /** @class */ (function () {
                function GameStateControlsComponent(gameService) {
                    this.gameService = gameService;
                }
                GameStateControlsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.subscriptionLost = this.gameService.onLostGame().subscribe(function () {
                        _this.isPlaying = false;
                    });
                    this.subscriptionState = this.gameService.getGameState().subscribe(function (action) {
                        _this.isPlaying = action !== _enums_game_state_enum__WEBPACK_IMPORTED_MODULE_2__["GameState"].PAUSE;
                    });
                };
                GameStateControlsComponent.prototype.ngOnDestroy = function () {
                    this.subscriptionState.unsubscribe();
                };
                GameStateControlsComponent.prototype.keyBoardInput = function (event) {
                    event.preventDefault();
                    switch (event.code) {
                        case 'KeyP':
                            this.pauseGame();
                ...
                GameStateControlsComponent.prototype.resetGame = function () {
                ...
                GameStateControlsComponent.prototype.pauseGame = function () {
                    this.gameService.setGameState(_enums_game_state_enum__WEBPACK_IMPORTED_MODULE_2__["GameState"].PAUSE);
                };
                GameStateControlsComponent.prototype.playGame = function () {
                    if (this.isPlaying) {
                        return;
                    }
                    this.gameService.setGameState(_enums_game_state_enum__WEBPACK_IMPORTED_MODULE_2__["GameState"].PLAY);
                };
                return GameStateControlsComponent;
            }());
            GameStateControlsComponent.ctorParameters = function () { return [
                { type: _services_game_service__WEBPACK_IMPORTED_MODULE_3__["GameService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:keydown', ['$event'])
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlayerProfileComponent = /** @class */ (function () {
                function PlayerProfileComponent(userService, toastrService) {
                    this.userService = userService;
                    this.toastrService = toastrService;
                }
                ...
                PlayerProfileComponent.prototype.showCurrentUser = function () {
                ...
                PlayerProfileComponent.prototype.onLogout = function () {
            ...
            PlayerProfileComponent.ctorParameters = function () { return [
                { type: _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] },
                { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var QUANTITY_BLOCKS_WIDTH = 13;
            var QUANTITY_BLOCKS_HEIGHT = 20;
            var BLOCK_SIZE = 25;
            var BORDER_COLOR = '#979797';
            var CENTRAL_ITEM = 5;
            var DELAY_DEFAULT = 700;
            var DELAY_LEVEL_STEP = 100;
            var ACCELERATION = 22;
            var CANVAS_WIDTH = QUANTITY_BLOCKS_WIDTH * BLOCK_SIZE;
            var CANVAS_HEIGHT = QUANTITY_BLOCKS_HEIGHT * BLOCK_SIZE;
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var DEFAULT_LINE_SCORE = 5;
            var DEFAULT_STEP = 2;
            var GAME_STEP_LEVEL = 3;
            var LEADERBOARD_MAX_WIDTH = 10;
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BoardModel = /** @class */ (function () {
                function BoardModel(ctx, isNextFigure) {
                    this.ctx = ctx;
                    this.isNextFigure = isNextFigure;
                }
                BoardModel.makeBoardEmptyMatrix = function (width, height) {
                ...
                BoardModel.findFilledLine = function (figure, board, lineIndex) {
                    return figure
                        .map(function (item, index) {
                        return lineIndex - 1 + index < _constants_board_component_const__WEBPACK_IMPORTED_MODULE_4__["QUANTITY_BLOCKS_HEIGHT"] &&
                            board[lineIndex - 1 + index].every(function (block) { return block !== _enums_figures_colors_enum__WEBPACK_IMPORTED_MODULE_1__["FiguresColors"].DEFAULT; })
                            ? index
                            : -1;
                    })
                        .filter(function (index) { return index !== -1; });
                };
                BoardModel.prototype.drawBoard = function (matrix) {
                    var _this = this;
                    matrix.forEach(function (line, indexY) {
                        line.forEach(function (item, indexX) {
                            (_this.isNextFigure
                                ? new _next_block_model__WEBPACK_IMPORTED_MODULE_2__["NextBlockModel"](_this.ctx, item)
                                : new _game_block_model__WEBPACK_IMPORTED_MODULE_3__["GameBlockModel"](_this.ctx, item)).fillBoardBlock(indexX, indexY);
                        });
                    });
                };
                return BoardModel;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FigureModel = /** @class */ (function () {
                function FigureModel() {
                }
                FigureModel.getRandomFigure = function () {
                ...
                FigureModel.prototype.showFigure = function (lineHeight, figureMatrix, boardMatrix, figurePosition) {
                    var matrixWithFigure = boardMatrix.slice();
                    figureMatrix.forEach(function (line, indexLine) {
                        ...
                        if (indexLine + lineHeight < _constants_board_component_const__WEBPACK_IMPORTED_MODULE_3__["QUANTITY_BLOCKS_HEIGHT"]) {
                            var targetLine = boardMatrix[indexLine + lineHeight].slice();
                            var activeBlocksLine = line.filter(function (block, blockPosition) {
                            ...
                            targetLine.splice.apply(targetLine, [figurePosition + activePosition, activeBlocksLine.length].concat(activeBlocksLine));
                            matrixWithFigure[indexLine + lineHeight] = targetLine.slice();
                        }
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameBlockModel = /** @class */ (function (_super) {
                __extends(GameBlockModel, _super);
                function GameBlockModel() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                GameBlockModel.prototype.fillStroke = function (x, y) {
                    this.ctx.strokeRect(x * _constants_board_component_const__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"], y * _constants_board_component_const__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"], _constants_board_component_const__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"], _constants_board_component_const__WEBPACK_IMPORTED_MODULE_1__["BLOCK_SIZE"]);
                };
                return GameBlockModel;
            }(_block_model__WEBPACK_IMPORTED_MODULE_2__["BlockModel"]));
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NextBlockModel = /** @class */ (function (_super) {
                __extends(NextBlockModel, _super);
                function NextBlockModel() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                NextBlockModel.prototype.fillStroke = function (x, y) {
            ...
            }(_block_model__WEBPACK_IMPORTED_MODULE_1__["BlockModel"]));
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameService_1;
            var GameService = GameService_1 = /** @class */ (function () {
                ...
                GameService.calculateScore = function (lines, level) {
                    return ((lines / 2) *
                ...
                GameService.prototype.setLostGame = function () {
                    this.isLostGame = true;
                    var gameResult = {
                ...
                GameService.prototype.getPlayerGameResult = function () {
                    return this.http
                        .get(this.endpoint + "/result")
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.map(function (el) { return new _models_game_result_model__WEBPACK_IMPORTED_MODULE_9__["GameResult"](el); }); }));
                };
                GameService.prototype.onLostGame = function () {
                    return this.lostGameSubject.asObservable();
                };
                GameService.prototype.setMoveStep = function (step) {
                    if (this.isPlaying && !this.isLostGame) {
                        this.movementSubject.next(step);
                    }
                };
                GameService.prototype.onNextStep = function () {
                    return this.movementSubject.asObservable();
                };
                GameService.prototype.setGameState = function (action) {
                ...
                GameService.prototype.updateFigures = function () {
                    this.currentFigure = this.nextFigure;
                    var previousFigure = this.currentFigure;
                    var randomNextFigure = _models_figure_model__WEBPACK_IMPORTED_MODULE_7__["FigureModel"].getRandomFigure();
                    this.nextFigure = randomNextFigure;
                    this.nextFigureSubject.next({
                        previousFigure: previousFigure,
                        randomNextFigure: randomNextFigure,
                    });
                };
                GameService.prototype.onNewFigureCreated = function () {
                    return this.nextFigureSubject.asObservable();
                };
                GameService.prototype.setNumberFilledLines = function (numberLines) {
                    var initialScore = numberLines * _constants_game_information_const__WEBPACK_IMPORTED_MODULE_8__["DEFAULT_STEP"];
                    ...
                    var lines = this.currentNumberLines;
                    var score = this.currentScore;
                    var level = this.currentLevel;
                    this.numberLinesSubject.next({ lines: lines, score: score, level: level });
                };
                GameService.prototype.setInitialInformation = function () {
                    this.currentLevel = 1;
                    this.currentScore = 0;
                    this.currentNumberLines = 0;
                    var lines = this.currentNumberLines;
                ...
                GameService.prototype.onUpdateGameInformation = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.loginUser = function (userInform) {
                    var md5 = new ts_md5_dist_md5__WEBPACK_IMPORTED_MODULE_4__["Md5"]();
                    var userData = {
                ...
                UserService.prototype.getAuthListener = function () {
